      ...
      {stage === "attract" && (
        <div className="relative w-full h-dvh flex flex-col items-center justify-center overflow-hidden">
          ...
          {/* Unobtrusive on purpose — this is a customer-facing showcase, and
              the passcode entry is a staff affordance, not the headline. */}
          <Link
            href="/pin"
            className="absolute bottom-4 left-4 text-cream/40 hover:text-cream/80 text-[10px] font-mono tracking-[0.14em] uppercase px-2 py-1 min-h-[44px] min-w-[44px] flex items-center"
          >
            Staff passcode
          </Link>
