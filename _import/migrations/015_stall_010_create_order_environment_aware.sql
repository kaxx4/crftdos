-- version: 20260811181845
-- applied name: stall_010_create_order_environment_aware
...
begin
  ...
  -- Environment resolution. Optional payload field; falls back to the
  -- shift's environment, then to the column default (HQ), so callers that
  -- never mention environments keep behaving exactly as before.
